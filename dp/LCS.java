...
public class LCS {
	...
	public static int lcsrdp(String str1,String str2,int i,int j,int[][] dp) {
		if(i==str1.length() || j == str2.length()) {
			return 0;
		}
	...
	public static int lcsidp(String str1,String str2) {
		int m = str1.length();
		int n = str2.length();
...
//	}
//	
//	int ans = lcsrdp(str1,str2,0,0,dp);
//	System.out.println(ans);
//	for(int i=0;i<dp.length;i++) {
//		for(int j=0;j<dp[i].length;j++) {
//			System.out.print(dp[i][j] + " ");
